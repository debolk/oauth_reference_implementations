$(document).ready(function(){
    ...
    var oauth = new OAuth({
        ...
        client: 'reference-implementation', // While these credentials work, you MUST change them through auth.debolk.nl
        secret: 'MO3632MPM3RP2K',           // While these credentials work, you MUST change them through auth.debolk.nl
